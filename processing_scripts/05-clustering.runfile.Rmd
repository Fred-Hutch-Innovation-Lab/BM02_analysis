...
# }
for (smple in metadata$Sample[metadata$Kit=='Fluent_v4']) {
  leiden_sweep_res[[smple]] <- clusterSweepLeiden(objs[[smple]], resolutions = seq(0.001, 0.01, 0.0001))
}
for (smple in metadata$Sample[metadata$Kit=='Fluent_v5']) {
  leiden_sweep_res[[smple]] <- clusterSweepLeiden(objs[[smple]], resolutions = seq(0.0005, 0.01, 0.0001))
}
# for (smple in c('FB_2_F1A','FB_2_F1B','FB_2_F5A','FB_2_F5B' )) {
#   leiden_sweep_res[[smple]] <- NULL
# }
for (smple in metadata$Sample[metadata$Kit=='BD']) {
  leiden_sweep_res[[smple]] <- clusterSweepLeiden(objs[[smple]], resolutions = seq(0.005, 0.1, 0.0001))
}
