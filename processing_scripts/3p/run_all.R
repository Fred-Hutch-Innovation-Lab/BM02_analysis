...
rmarkdown::render(here('processing_scripts/3p/01-ambient_RNA_check.runfile.Rmd'))
rmarkdown::render(here('processing_scripts/3p/02-cell_filtering.runfile.Rmd'))
rmarkdown::render(here('processing_scripts/3p/03-gene_analysis.runfile.Rmd'))
rmarkdown::render(here('processing_scripts/3p/04-reference_annotation.runfile.Rmd'))
rmarkdown::render(here('processing_scripts/3p/05-clustering.runfile.Rmd'))
