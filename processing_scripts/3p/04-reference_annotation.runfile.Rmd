...
```{r}
objs <- readRDS(here('rds/3p/03-objs_post_gene_filtering.rds'))
...
```{r}
saveRDS(objs, here('rds/3p/04_objs_post_annotation.rds'), compress=FALSE)
```
...
## aesthetics 
rmarkdown::render(here('processing_scripts/3p/04-reference_annotation.format.Rmd'),
