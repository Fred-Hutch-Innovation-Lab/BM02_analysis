...
```{r}
source(here('config/tcr/generate_metadata.R'))
metadata <- read.csv(here('config/tcr/metadata.csv'))
```
...
## aesthetics 
rmarkdown::render(here('processing_scripts/tcr/01-tcr_analysis.format.Rmd'),
                  output_file = '01-clone_qc.html',
                  output_dir = here('reports/tcr/'))
```