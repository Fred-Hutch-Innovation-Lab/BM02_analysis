...
```{r}
objs <- readRDS(here('rds/wt/05_merged_objs_post_clustering.rds'))
...
shared_genes <- read.table(here('rds/wt/gene_whitelist.txt'))$V1
...
```{r, eval=TRUE}
saveRDS(objs, here('rds/wt/07_post_module_scoring.rds'), compress=FALSE)
```
...
## aesthetics 
rmarkdown::render(here('processing_scripts/wt/07-celltype_resolution.format.Rmd'),
