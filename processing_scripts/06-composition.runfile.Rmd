...
objs <- lapply(objs, function(x) {
  x@meta.data <- x@meta.data |>
    mutate(orig.ident = case_when(
      grepl('FBv4', orig.ident) ~ gsub('FBv4', 'Fluent_v4', orig.ident),
      grepl('FBv5', orig.ident) ~ gsub('FBv5', 'Fluent_V', orig.ident),
      grepl('PA_V3', orig.ident) ~ gsub('PA_V3', 'Parse_v3', orig.ident),
      .default = orig.ident
    )) 
  x
})
