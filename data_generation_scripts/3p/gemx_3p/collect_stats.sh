...
indir="/fh/fast/_IRC/FHIL/grp/BM_paper/processing/bm02_wt_3p/gemx_3p/sat_curves"
targets=(1000 2500 5000 7500 10000 12500 15000 17500 20000 22500 25000)

echo "kit,sample,target,umis,genes" > $indir/gemx_3p_satcurves.csv
for directory in $indir/GEMX*; do
    ...
    for target in ${targets[@]}; do
        ...
        awk '{ gsub(/^[ \t]+|[ \t]+$/, "", $0); print }');
        echo "GEMX_3P,$sample,$target,$umi,$genes" >> $indir/gemx_3p_satcurves.csv
    done
done