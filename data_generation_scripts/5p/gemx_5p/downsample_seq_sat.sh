...
sampledir='/fh/fast/_IRC/FHIL/grp/BM_paper/fastqs/bm01_tcr_5p/gemx_5p/downsampled/Subsampled25k_WT_Fastqs'
outdir='/fh/fast/_IRC/FHIL/grp/BM_paper/fastqs/bm01_tcr_5p/gemx_5p/sat_curves/'
...
sample_total_reads=(["F1"]=468500000 ["F2"]=578825000 ["F4"]=538300000 ["F5"]=490400000)

SLURM_OPTS="--job-name=downsample_gemx \
             --output=sbatch.out \
             --error=sbatch.err \
             --nodes=1 \
             --ntasks=1 \
