...
indir="/fh/fast/_IRC/FHIL/grp/BM_paper/processing/bm01_tcr_5p/nextgem_5p/sat_curves"
targets=(1000 2500 5000 7500 10000 12500 15000 17500 20000 22500 25000)

echo "kit,sample,target,umis,genes" > $indir/nextgem_5p_satcurves.csv
for directory in $indir/F*; do
    ...
    for target in ${targets[@]}; do
        ...
        awk '{ gsub(/^[ \t]+|[ \t]+$/, "", $0); print }');
        echo "NextGEM_5P,$sample,$target,$umi,$genes" >> $indir/nextgem_5p_satcurves.csv
    done
done