...
rmarkdown::render(here('figure_scripts/report.Rmd'),
...
```{r, fig.height=8}
source(here('figure_scripts/pipeline_metrics_table.R'))
qc_metrics_table
# knitr::include_graphics(here('figures/metrics_table.png'))
```
...
```{r}
knitr::include_graphics(here('figures/saturation_curves.png'))
